...
layui.define("view", function(e) {
		...
		C = {
			...
			sendAuthCode: function(e) {
				...
				var t, i = e.seconds,
					n = function(l) {
						var s = a(e.elem);
						i--, i < 0 ? (s.removeClass(y).html("获取验证码"), i = e.seconds, clearInterval(t)) : s.addClass(y).html(i + "秒后重获"),
			...
			sideFlexible: function(e) {
				var t = u,
					i = a("#" + f),
					l = C.screen();
				"spread" === e ? (i.removeClass(b).addClass(v), l < 2 ? t.addClass(h) : t.removeClass(h), t.removeClass(g)) : (i
					.removeClass(v).addClass(b), l < 2 ? t.removeClass(g) : t.addClass(g), t.removeClass(h)), layui.event.call(
			...
			theme: function(e) {
				var i = (n.theme, layui.data(n.tableName)),
					...
					r = t([".layui-side-menu,", ".layadmin-pagetabs .layui-tab-title li:after,",
					...
					].join("")).render(e = a.extend({}, i.theme, e)),
					u = document.getElementById(l);
				"styleSheet" in s ? (s.setAttribute("type", "text/css"), s.styleSheet.cssText = r) : s.innerHTML = r, s.id = l,
					u && o[0].removeChild(u), o[0].appendChild(s), o.attr("layadmin-themealias", e.color.alias), i.theme = i.theme ||
			...
			initTheme: function(e) {
				var a = n.theme;
				e = e || 0, a.color[e] && (a.color[e].index = e, C.theme({
					color: a.color[e]
				}))
			},
			tabsPage: {},
			...
			tabsBodyChange: function(e) {
				C.tabsHeader(e).attr("lay-attr", layui.router().href), C.tabsBody(e).addClass(c).siblings().removeClass(c), k.rollPage(
					"auto", e)
			},
			resize: function(e) {
				var a = layui.router(),
					t = a.path.join("-");
				C.resizeFn[t] && (r.off("resize", C.resizeFn[t]), delete C.resizeFn[t]), "off" !== e && (e(), C.resizeFn[t] = e,
			...
			serach: function(e) {
				e.off("keypress").on("keypress", function(a) {
					if (this.value.replace(/\s/g, "") && 13 === a.keyCode) {
						...
						t += this.value, i = i + ' <span style="color: #FF5722;">' + C.escape(this.value) + "</span>", location.hash =
							C.correctRouter(t), k.serach.keys || (k.serach.keys = {}), k.serach.keys[C.tabsPage.index] = this.value,
							this.value === k.serach.keys[C.tabsPage.index] && k.refresh(e), this.value = ""
					}
				})
			},
			message: function(e) {
	...
	! function() {
		...
		e.theme ? C.theme(e.theme) : n.theme && C.initTheme(n.theme.initColorIndex), o.addClass("layui-layout-body"), C.screen() <
			1 && delete n.pageTabs, n.pageTabs || u.addClass("layadmin-tabspage-none"), s.ie && s.ie < 10 && l.error("IE" + s.ie +
		...
		e.siblings(".layui-nav-child")[0] && u.hasClass(g) && (C.sideFlexible("spread"), layer.close(e.data("index"))), C
			.tabsPage.type = "nav"
	...
	o.on("click", z, function() {
		var e = a(this),
			t = e.index();
		return C.tabsPage.type = "tab", C.tabsPage.index = t, "iframe" === e.attr("lay-attr") ? C.tabsBodyChange(t) : (F(
			e), C.runResize(), void C.resizeTable())
